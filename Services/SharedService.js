cscSnapshots.factory('SharedService', function($location) {
  ...
  switch (host.toLowerCase()){
    case "csc.noaa.gov":  // Prod
    case "www.csc.noaa.gov":  // Prod
      argis = "http://maps.csc.noaa.gov/arcgis/rest/services/Snapshot/";
      snapshots = "http://csc.noaa.gov/dataservices/Snapshot/v2/";
      isProduction = true;
      break;
    case "webqa.csc.noaa.gov":  // QA
      // argis = "http://csc.noaa.gov/ArcGIS_QA/rest/services/Snapshot/";
      argis = "http://maps.csc.noaa.gov/arcgis/rest/services/Snapshot/";
      snapshots = "http://webqa.csc.noaa.gov/dataservices/Snapshot/v2/";
      break;
    default:  // Dev
      // argis = "http://csc.noaa.gov/ArcGIS_QA/rest/services/Snapshot/";
      argis = "http://maps.csc.noaa.gov/arcgis/rest/services/Snapshot/";
